...
[get_cwa_rest_services_get_facility_info](https://echo.epa.gov/tools/web-services/facility-search-water#!/Facility_Information/get_cwa_rest_services_get_facility_info)
...
can specify what data you want returned. Use
[`echoWaterGetMeta()`](https://mps9506.github.io/echor/reference/echoWaterGetMeta.md)
to return a dataframe with column numbers, names, and descriptions to
...
to download tidy dataframes of permitted water discharger Discharge
