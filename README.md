...
## Session Info
    ...
    #>    echor        * 0.1.6.9000 2022-12-22 [1] local
    ...
    #>  P mpsTemplates * 0.1.0      2022-12-22 [?] Github (mps9506/mpsTemplates@7512223)
